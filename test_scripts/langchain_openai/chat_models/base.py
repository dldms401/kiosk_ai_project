...
class ChatOpenAI(BaseChatModel):
    ...
    def get_num_tokens_from_messages(self, messages: List[BaseMessage]) -> int:
        ...
        if model.startswith("gpt-3.5-turbo-0301"):
            ...
            tokens_per_name = -1
        # My fine tuning gpt added
        elif model.startswith("gpt-3.5-turbo") or model.startswith("gpt-4") or model.startswith("ft:gpt-3.5-turbo-0125:personal:cafebot:9Ly4475o"):
